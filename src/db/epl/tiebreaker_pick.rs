...
pub struct EplTiebreakerPick {
    pub player_id: i64,
    pub player_name: String,
    pub team_name: String,
}

impl EplTiebreakerPick {
    pub fn upsert(
        conn: &Connection,
        season_id: i64,
        user_id: u64,
        ...
        conn.execute(
            "
            INSERT INTO epl_tiebreaker_picks (
    ...
    pub fn get_for_user(
        ...
        conn.query_row(
            ...
            FROM epl_tiebreaker_picks
            WHERE season_id = ?1 AND user_id = ?2
            ",
            params![season_id, user_id as i64],
            |row| {
                Ok(EplTiebreakerPick {
                    player_id: row.get(0)?,
    ...
    pub fn delete_for_team(
        ...
        conn.execute(
            "
            DELETE FROM epl_tiebreaker_picks
